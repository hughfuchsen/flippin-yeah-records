const artists = [
  {
    name: "Darren Hanlon",
    images: ["/darren.jpg", "/darrenHanlon2.jpg", "/darrenHanlon3.jpg", "/darrenHanlon4.jpg", "/darrenHanlon5.jpg"],
  ...
  },
  {
    ...
    images: ["/kankawa.jpg", "/kankawaNagarra2.jpg", "/kankawaNagarra3.jpg"],
  ...
  {
    name: "Jack Davies",
    images: ["/jackD.jpg", "/jackD2.jpg", "/jackDavies3.jpg"],
  ...
  {
    name: "Roger Knox",
    images: ["/Roger1.jpg", "/Roger0.jpg", "/Roger2.jpg", "/Roger3.jpg", "/Roger5.jpg"],
    bio: `Roger Knox is a legendary Aboriginal Australian country singer-songwriter, affectionately known as the “Black Elvis” and dubbed the “Koori King of Country.” Born in 1948 into the Gomeroi nation at Toomelah Mission near Moree, NSW, he grew from a gospel-rooted childhood into a transformative cultural icon in country music.
    \n\n
    Survived two devastating plane crashes in 1980–81 that nearly claimed his life; his recovery marked a spiritual rebirth and led to the formation of the Euraba Band (named after a healing bush and place)
    \n\n
  ...
  },
  {
    ...
    images: ["/jonathan.jpg", "jonathanRichman2.jpg"],
    bio: `Flippin Yeah Records are honoured to have Jonathan Richman on the label as his music (and ways of thinking about music) have influenced many of the other artists on the label. Much of his long history has been written about many places elsewhere. Why is he releasing music on this little Australian label? When Darren Hanlon was visiting him in his little town in California he expressed that he’d like his music in Australia to be easier to find. He also found Hanlon’s way of operating appealed to him. We hope to release more of his new music in the future.`,
    website: "null",
    productLink: "https://flippinyeahindustries.bigcartel.com/artist/jonathan-richman"
  },
  {
    name: "Ruth Parker",
    images: ["/ruthParker.jpg"],
  ...
  {
    name: "Jerrah Patston",
    images: ["/jerrahPatston.jpg", "/jerrahPatston2.jpg", "/jerrahPatston3.jpg"],
    bio: `Jerrah Patston is a prolific singer/songwriter with a distinct sound which combines elements of country and new folk with an ear for an anthemic pop chorus. Patston is gifted with a deft ability to channel ordinary and extraordinary observations about the world around him into catchy songs that will get stuck in your head.
    \n\n
    His upcoming album is Abandoned Cricket Games, recorded over two days at Frying Pan Studios in Berriedale, Tasmania, using the ex-Abbey Road REDD.17 recording console documents minor catastrophes, in the classic tradition of folk-rock songs about disaster and disappointment.`,
    website: "null",
